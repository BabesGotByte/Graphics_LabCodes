...
// In this code I have implemented formation of a pentagon using mouse clicks and then filling color in the pentagon using boundary fill.
#include <GL/glut.h>
#include <cmath>
...
int main (int argc, char** argv)
{
	...
	glutCreateWindow("Border Fill and then Boundary fill");
...
/*How to use
First click anywhere on the screen for five times and then a pentagon will be formed. The pentagon would be first colored using boundary fill algorithm*/