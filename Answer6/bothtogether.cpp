...
// In this code I have implemented formation of a pentagon using mouse clicks and then filling color in the pentagon using boundary fill and then flood fill.
#include <GL/glut.h>
#include <cmath>
...
/*How to use
First click anywhere on the screen for five times and then a pentagon will be formed. The pentagon would be first colored using boundary fill algorithm and then using flood fill algorithm.*/